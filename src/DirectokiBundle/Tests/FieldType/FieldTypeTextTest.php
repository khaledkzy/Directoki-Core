 ...
 */
class FieldTypeTextTest extends BaseTest
{
    ...
    function testParseCSVLineDataTest1() {
        ...
        $event = new Event();
        $publish = false;
        $fieldType = new FieldTypeText($this->container);
        ...
        $this->assertEquals("DirectokiBundle\Entity\RecordHasFieldTextValue", get_class($result->getFieldValuesToSave()[0]));
