 ...
 */
class FieldChangeStringToTextWithDataBaseTest extends BaseTestWithDataBase {
    ...
    public function testText1() {
        ...
        # CHANGE!
        $action = new ChangeFieldTypeStringToText($this->container);
        $action->change($field1);

        # TEST AGAIN
        $field1 = $this->em->getRepository('DirectokiBundle:Field')->findOneByPublicId('field1');
        $this->assertEquals(FieldTypeText::FIELD_TYPE_INTERNAL, $field1->getFieldType());
