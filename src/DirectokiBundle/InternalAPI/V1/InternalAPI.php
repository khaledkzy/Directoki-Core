...
class InternalAPI {
    ...
    function getPublishedRecords($projectID, $directoryID) {
      return $this->getProjectAPI($projectID)->getDirectoryAPI($directoryID)->getPublishedRecords();
    }
    ...
    function getPublishedRecord($projectID, $directoryID, $recordID) {
        return $this->getProjectAPI($projectID)->getDirectoryAPI($directoryID)->getRecordAPI($recordID)->getPublished();
    }
    ...
    function getPublishedRecordEdit(Record $record) {
        return $this->getProjectAPI($record->getProjectPublicId())->getDirectoryAPI($record->getDirectoryPublicId())->getRecordAPI($record->getPublicID())->getPublishedEdit();
    }
    ...
    function savePublishedRecordEdit(RecordEdit $recordEdit, Request $request = null) {
        return $this->getProjectAPI($recordEdit->getProjectPublicId())->getDirectoryAPI($recordEdit->getDirectoryPublicId())->getRecordAPI($recordEdit->getPublicID())->savePublishedEdit($recordEdit, $request);
    }
     ...
     * @deprecated
     */
    function getRecordCreate($projectID, $directoryID) {
        return $this->getProjectAPI($projectID)->getDirectoryAPI($directoryID)->getRecordCreate();
    ...
    function saveRecordCreate(RecordCreate $recordCreate, Request $request = null) {
        return $this->getProjectAPI($recordCreate->getProjectPublicId())->getDirectoryAPI($recordCreate->getDirectoryPublicId())->saveRecordCreate($recordCreate, $request);
    }
